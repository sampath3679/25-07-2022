...
export class OperationDetails {
    ...
    public readonly introductionIsOpen: ko.Observable<boolean>;
    public readonly api: ko.Observable<Api>;
    public readonly schemas: ko.ObservableArray<string>;
    public readonly modelpopupIsOpen: ko.Observable<boolean>;
    ...
    public readonly responsename: ko.Observable<any>;
    ...
    constructor(
        ...
        this.introductionIsOpen = ko.observable();
        ...
        this.modelpopupIsOpen = ko.observable();
    ...
    public async initialize(): Promise<void> {
        ...
        var operationName = this.routeHelper.getOperationName();
    ...
    public closeConsolepopup(): void {
        this.modelpopupIsOpen(false);
    }

    public showDialog(data: any): void {
        this.responsename(data);
        console.log(data);
        this.modelpopupIsOpen(true);
    }
