...
export class OperationList {
    ...
    constructor(
        ...
        this.introductionIsOpen = ko.observable(true);
    ...
    private async onRouteChange(): Promise<void> {
        const apiName = this.routeHelper.getApiName();
        const operationName = this.routeHelper.getOperationName();
        this.routeForIntroducton='api-details#api='+apiName+'&operation='+operationName;
    ...
    private async getApiType(): Promise<string> {
        ...
        this.routeForIntroducton='api-details#api='+apiName+'&operation=introduction';
     ...
     public openIntroduction(): void {
        localStorage.setItem("stored_contacts","true");
    }
